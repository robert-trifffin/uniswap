...
var (
	pattern_Query_User_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"robert-trifffin", "uniswap", "user", "id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_UserAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"robert-trifffin", "uniswap", "user"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pool_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"robert-trifffin", "uniswap", "pool"}, "", runtime.AssumeColonVerbOpt(true)))
)
