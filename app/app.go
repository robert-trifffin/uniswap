...
import (
	...
	uniswapmoduletypes "github.com/robert-trifffin/uniswap/x/uniswap/types"

	"github.com/tendermint/spm/cosmoscmd"
)

const (
	AccountAddressPrefix = "uni"
	Name                 = "uniswap"
)
...
type App struct {
	*baseapp.BaseApp
	...
	UniswapKeeper uniswapmodulekeeper.Keeper
...
func New(
	...
	app.UniswapKeeper = *uniswapmodulekeeper.NewKeeper(
		appCodec,
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(uniswapmoduletypes.ModuleName)
